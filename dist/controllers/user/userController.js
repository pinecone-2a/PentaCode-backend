...
exports.verifyCookie = exports.updatePassword = exports.resetPassword = exports.verifyOtp = exports.forgotPassword = exports.verifyUser = exports.checkUser = exports.addUser = exports.users = void 0;
...
const checkUser = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const refreshToken = jsonwebtoken_1.default.sign({ userId: newUser.id }, process.env.REFRESH_TOKEN_SECRET, { expiresIn: "1h" });
...
const verifyUser = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (isPasswordCorrect) {
            const refreshToken = jsonwebtoken_1.default.sign({ userId: user.id }, process.env.REFRESH_TOKEN_SECRET, { expiresIn: "1h" });
...
const verifyCookie = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (error instanceof jsonwebtoken_1.default.TokenExpiredError) {
            ...
            try {
                const refreshUser = jsonwebtoken_1.default.verify(refreshToken, process.env.REFRESH_TOKEN_SECRET);
                console.log("Refresh User:", refreshUser);
                if (refreshUser) {
                    const newAccessToken = (0, userJWT_1.generateAccessToken)(refreshUser.userId);
